    ...
    <div>
      ...
      <div className="mt-6 grid max-w-2xl gap-3 sm:grid-cols-2">
        <AttachmentUpload
          ...
          canManage={canForm}
          uploadAction={uploadPlanWeekEntryAttachment.bind(null, id)}
          deleteAction={form ? deletePlanWeekEntryAttachment.bind(null, id, form.id) : undefined}
        />
        <AttachmentUpload
          label="Fatura"
          kind="INVOICE"
          ...
          uploadAction={uploadPlanWeekEntryAttachment.bind(null, id)}
          deleteAction={
            invoice ? deletePlanWeekEntryAttachment.bind(null, id, invoice.id) : undefined
          }
        />
      </div>
